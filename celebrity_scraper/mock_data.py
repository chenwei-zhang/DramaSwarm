...
def generate_mock_relationships(name: str) -> list[Relationship]:
    ...
    relationship_map = {
        ...
        ("贾乃亮", "PG One"): {"type": "对手", "current": False, "conf": 0.95, "str": 0.1,
                             "desc": "夜宿门事件中贾乃亮为受害者一方，两人关系敌对"},
        ("PG One", "贾乃亮"): {"type": "对手", "current": False, "conf": 0.95, "str": 0.1,
                             "desc": "因夜宿门事件导致贾乃亮离婚，两人关系彻底敌对"},
